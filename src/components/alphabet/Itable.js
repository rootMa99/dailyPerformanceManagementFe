    ...
    >
      <tr>
        ...
        <td
          className={c.corner}
          rowSpan="2"
          style={colorDays(filtredData, 1, p.date, "rev")}
        ...
        <td
          className={c.corner}
          style={colorDays(filtredData, 2, p.date, "rev")}
      ...
      <tr>
        ...
        <td
          className={c.corner}
          style={colorDays(filtredData, 9, p.date, "rev")}
      ...
      <tr>
        ...
        <td
          className={c.corner}
          style={colorDays(filtredData, 16, p.date, "rev")}
      ...
      <tr>
        ...
        <td
          className={c.corner}
          colSpan="2"
          style={colorDays(filtredData, 23, p.date, "rev")}
      ...
      <tr>
        ...
        <td
          className={c.corner}
          style={colorDays(filtredData, 30, p.date, "rev")}
        ...
        <td
          className={c.corner}
          colSpan="2"
          style={colorDays(filtredData, 31, p.date, "rev")}
